...
def train():
    ...
    model = transformers.LlamaForCausalLM.from_pretrained(   #LlamaForCausalLM  OPTForCausalLM
        model_args.model_name_or_path,
        cache_dir=training_args.cache_dir,
    )

    tokenizer = transformers.LlamaTokenizer.from_pretrained(  #LlamaTokenizer  AutoTokenizer
        model_args.model_name_or_path,
        cache_dir=training_args.cache_dir,
