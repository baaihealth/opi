...
def main():
    ...
    for line in content:
        ...
        tokenizer = AutoTokenizer.from_pretrained("/path/to/Galactica/Galactica-6.7B")
        model = OPTForCausalLM.from_pretrained("/path/to/Galactica/Galactica-6.7B", device_map="auto")
