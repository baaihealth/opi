...
parser.add_argument('--output_dir', default="./eval_galai_output", type=str)
...
if __name__ == '__main__':
    ...
    for test_f in test_files:
        ...
        if args.data_file is None:
            ...
            args.predictions_file = os.path.join(args.output_dir, f"{test_file_name}_{args.model_idx}.json")
